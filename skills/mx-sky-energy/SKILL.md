...
收益查询（`earnings-week`、`earnings-year`、`solar`）的输出顺序**固定为**：
...
**caption 示例**：
```
☀️ Sunny 上周收益 03/29-04/04  合计: $752.60
```
...
```
周四小幅亏损，其余均为正收益，周五最高（+$235.99）

最高: $235.99（周五）
最低: -$9.50（周四）
合计:  $752.60 ✅

建议：周四售电倒贴较重，可考虑在周五高价时段前适当充电。
```
